...
| IDEM-04 | P1: Tenant e idempotência | Design | Verified |
| TEN-01 | P1: Tenant e idempotência | Design | Verified |
| TEN-02 | P1: Tenant e idempotência | Design | Verified |
| TEN-03 | P1: Tenant e idempotência | Design | Verified |
...
| K8S-05 | P2: Envoy Gateway em Kubernetes | Design | Verified |
| API-01 | P3: Contrato e versionamento | Design | Verified |
| API-02 | P3: Contrato e versionamento | Design | Verified |
| API-03 | P3: Contrato e versionamento | Design | Verified |
