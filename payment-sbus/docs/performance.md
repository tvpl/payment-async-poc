...
O cenário cross-boundary alvo (AD-007, supersede AD-006) é 1.000 req/min por 15 minutos e spike de 2.000 req/min por 60 segundos, com latência média ≤ 300ms e p99 ≤ 10s. Este pacote não declara certificação: throughput, lag, backlog, drain time, percentis, heap, pools e erros precisam constar em relatório datado do ambiente de referência.
