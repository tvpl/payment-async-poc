...
# Vendorizado de github.com/yannh/kubeconform@v0.8.0 (scripts/openapi2jsonschema.py,
# licença MIT), sem alteração de comportamento. Converte CRDs (OpenAPI v3) para os
# JSON Schemas que o kubeconform consome. Ver gateway/k8s/schemas/README.md para o
# comando de regeneração e a lista de CRDs vendorizadas em vendor/.
